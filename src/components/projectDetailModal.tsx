...
const ProjectDetailModal: React.FC<ProjectDetailModalProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-[#141439] border-blue-600/20 text-white max-w-4xl p-0 overflow-hidden">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-blue-300 text-sm">
                    {project.title.includes('–') ? project.title.split('–')[1].trim() : 'Project'}
                  </p>
                </div>
                ...
                <div className="flex bg-blue-900/30 rounded-lg p-1">
                  <button 
                    ...
                    className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm transition-all ${activeView === 'gallery' ? 'bg-blue-500 text-white' : 'text-blue-300 hover:bg-blue-800/30'}`}
                  >
                  ...
                  <button 
                    ...
                    className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm transition-all ${activeView === 'details' ? 'bg-blue-500 text-white' : 'text-blue-300 hover:bg-blue-800/30'}`}
                  >
